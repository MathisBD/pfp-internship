-- This module implements permutations on integers.
-- It is mainly used in Futhark.Util.BMatrix.

module Futhark.Util.Perm (
  Perm, size, fromList, toList, make,
  identity, Futhark.Util.Perm.reverse, swap,
